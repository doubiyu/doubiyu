            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li>
                        	<a href="<?php echo U('Admin/login/outlogin');?>">
                 ...
                 <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                   ...
                   <tbody>
                    ...
                    <?php if(is_array($users)): foreach($users as $key=>$vo): ?><tr class="gradeA odd" role="row">
                            ...
                            <td class="center"><?php switch($vo["type"]): case "0": ?>游客<?php break;?>    
                                              <?php case "1": ?>会员<?php break;?>    
                                              <?php case "2": ?>管理员<?php break;?>    
                                              <?php case "3": ?>超级管理员<?php break;?>
                                              <?php case "4": ?>此账号被冻结<?php break; endswitch;?>  
                                              </td>
                            <td class="center">
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('.btn-del').click(function(){
           ...
           //var t = $(this).parents('.gradeA').find('.dtype').html();
           // alert(v);
           //发送ajax
